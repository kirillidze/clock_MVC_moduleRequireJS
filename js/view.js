...
define(function() {
    ...
    class ClockSVGView {
        ...
        render(model) {
            ...
            this.secondHand.setAttribute('transform', `rotate(${sec*6} 400 300)`);
            this.minuteHand.setAttribute('transform', `rotate(${min*6} 400 300)`);
            this.hourHand.setAttribute('transform', `rotate(${hour*30 + min*0.5} 400 300)`);
        }
    ...
    return {
        ClockDOMView: ClockDOMView,
        ClockSVGView: ClockSVGView
    };
});